...
def results_to_natural_language(results, user_query):
    ...
    "never ever include '$'"
    "Important: Always format decimal numbers to show exactly 2 digits after the decimal point, always rounding if needed, and do not include extra trailing zeros beyond those two digits."
    ...
    "Always format decimal numbers to show exactly 2 digits after the decimal point, rounding if needed, and do not include extra trailing zeros beyond those two digits.\n"
